...
def main():
    ...
    # 映射字母为index
    train_word_file = '/media/data1/ocr_densenet/data/competition/train.csv'
    word_index_json = '/media/data1/ocr_densenet/data/alphabet_index_dict.json'
    word_count_json = '/media/data1/ocr_densenet/data/alphabet_count_dict.json'
    index_label_json = '/media/data1/ocr_densenet/data/train_alphabet.json'
