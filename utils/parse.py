...
parser.add_argument(
        ...
        '-d',
        type=str,
        default='/media/data1/ocr_densenet/data/competition/',
        help='data directory'
        )
parser.add_argument(
        '--bg-dir',
        type=str,
        default='/media/data1/ocr_densenet/data/images',
...
parser.add_argument('--save-dir',
        default='/media/data1/ocr_densenet/data',
        type=str,
        metavar='S',
        help='save dir')
parser.add_argument('--word-index-json',
        default='/media/data1/ocr_densenet/data/alphabet_index_dict.json',
        type=str,
        metavar='S',
        help='save dir')
parser.add_argument('--black-json',
        default='/media/data1/ocr_densenet/data/black.json',
        type=str,
        metavar='S',
        help='black_list json')
parser.add_argument('--image-hw-ratio-json',
        default='/media/data1/ocr_densenet/data/image_hw_ratio_dict.json',
        type=str,
        metavar='S',
        help='image h:w ratio dict')
parser.add_argument('--word-count-json',
        default='/media/data1/ocr_densenet/data/alphabet_count_dict.json',
        type=str,
        metavar='S',
        help='word count file')
parser.add_argument('--image-label-json',
        default='/media/data1/ocr_densenet/data/train_alphabet.json',
        type=str,
        metavar='S',
        help='image label json')
parser.add_argument('--resume',
        default='/media/data1/ocr_densenet/data/models-small/densenet/eval-48-0/best_f1score_603.ckpt',
        type=str,
        metavar='S',
